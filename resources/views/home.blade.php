 ...
 @section('content')
     ...
     <div class="relative h-screen">
         ...
         <div class="flex items-center justify-center relative">
             <h1 class="font-Ranade text-white text-5xl font-bold text-center z-10">Vítejte na naší stránce!</h1>
         <div class="relative">
